 ...
 *
 * Used for Demo Mode - data is isolated per browser tab and cleared when tab closes.
 * Perfect for allowing users to explore the app without affecting other tabs or persisting data.
 */
...
const STORAGE_PREFIX = 'lxnotes:demo:'

export class SessionStorageAdapter implements StorageAdapter {
  private storage: Storage

  constructor() {
    this.storage = createSafeStorage('lxnotes-demo-adapter', 'session')
  }
