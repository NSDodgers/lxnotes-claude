...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium transition-all duration-200 focus:outline-none focus:focus-theatrical status-badge",
  {
    variants: {
      variant: {
        default:
