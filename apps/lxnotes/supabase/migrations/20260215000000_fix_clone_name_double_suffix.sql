-- ============================================
-- FIX: Remove hardcoded ' (Copy)' suffix from clone mode
-- ============================================
-- The SQL function was appending ' (Copy)' to the production name,
-- but the frontend already handles naming (e.g. "X (Copy)").
-- This caused double-suffix: "X (Copy) (Copy)".
-- Now the function uses the name as provided by the caller.
