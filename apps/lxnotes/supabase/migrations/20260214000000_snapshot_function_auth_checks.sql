-- ============================================
-- PATCH: Add authorization checks to snapshot functions
-- ============================================
-- All three SECURITY DEFINER functions now verify the caller's identity
-- to prevent direct RPC calls from bypassing API route auth checks.
