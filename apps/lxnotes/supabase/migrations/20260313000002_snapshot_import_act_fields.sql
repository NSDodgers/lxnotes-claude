-- Add act_name and act_first_cue_number to import_production_snapshot
-- These columns were added to script_pages in 20260313000000 but the
-- snapshot import function was not updated to include them.
