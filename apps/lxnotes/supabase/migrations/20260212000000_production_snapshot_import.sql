-- ============================================
-- FUNCTION: IMPORT PRODUCTION SNAPSHOT
-- ============================================
-- Imports a production snapshot in either 'restore' or 'clone' mode
-- restore: replaces all data in the target production with snapshot data (original IDs preserved)
-- clone: creates a new production with remapped UUIDs
