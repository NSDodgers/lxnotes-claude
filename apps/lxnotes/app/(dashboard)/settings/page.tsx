...
export default function SettingsPage() {
  ...
  // instead of potentially stale data from the store
  useEffect(() => {
    if (productionContext?.production) {
      updateProduction({
        name: productionContext.production.name,
        abbreviation: productionContext.production.abbreviation,
        logo: productionContext.production.logo || DEFAULT_PRODUCTION_LOGO
      })
    }
  }, [productionContext?.production?.id, updateProduction, productionContext?.production])
