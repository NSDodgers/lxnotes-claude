...
import { Lightbulb, Wrench, Zap, FileText, Settings, LogOut } from 'lucide-react'
...
export function MobileDrawer() {
  ...
  const { isOpen, close } = useMobileDrawerStore()
  ...
  return (
    <>
      ...
      {/* Slide-in panel */}
      <aside
        className="fixed left-0 top-0 z-50 h-dvh w-[280px] bg-bg-secondary border-r border-bg-tertiary flex flex-col animate-fade-cue"
